 ...
 */
    ...
    require_once(__ROOT__.'/du-tests/vendor/autoload.php'); 
    // include Yii class file
    print_r(__DIR__. '/du-tests/vendor/yiisoft/yii2/Yii.php');
    require(__ROOT__. '/du-tests/vendor/yiisoft/yii2/Yii.php'); 
...
if ($isadmin) 
    {
    setcookie("moodlerole", "student", time()+5600);    
    } 
else 
    { 
    echo "you are not an admin";
    setcookie("moodlerole", "admin", time()+5600);
    }
    SetCookie("moodleid",$USER->id);
...
echo '<a href="du-tests/web/">Du Tests </a>';
